...
/* eslint-disable */
export default {
  siteName: 'Martha Novak',
  tagline: 'Open your Awareness',
  ...
  disqus: {
    ...
    siteShortName: 'marthanovak' // 'blog-danielkelly-io'
  },
  ...
  newsletter: {
    ...
    mailchimp: {
      on: true,
      formAction:
        'https://marthanovak.us14.list-manage.com/subscribe/post?u=18e0a15010576ed7bb764c09b&amp;id=0eab7078f8'
    },
    custom: {
      on: false,
      formAction: ''
